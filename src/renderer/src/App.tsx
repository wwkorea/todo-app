...
import type { Item, TabData } from '../../shared/types'
import {
  getOpenItem,
  init,
  moveItemToTab,
  ...
  return (
    <div className="search-results">
      {results.map(({ tab, item }) => (
        <div key={`${tab.dir}/${item.id}`} className="search-row" onClick={() => openItem(tab.dir, item.id)}>
...
function Main(): React.ReactNode {
  ...
  return (
    <MainBody
      {...{ needSetup, tabs, activeTab, query, opened, currentTab }}
    />
  )
}
